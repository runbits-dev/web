...
export const MODULES: Module[] = [
  ...
  { id: 'loyalty-program', name: 'Programa de fidelidad', description: 'Puntos y recompensas para clientes frecuentes.', price: 15, minPlan: 'pro', category: 'sales', applicableTo: ['all'], comingSoon: true },
  ...
  { id: 'ai-assistant', name: 'Asistente IA', description: 'IA que responde consultas de tus clientes 24/7.', price: 20, minPlan: 'enterprise', category: 'communication', applicableTo: ['all'], comingSoon: true },
