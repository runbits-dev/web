...
const VERTICAL = 'realtime' as const
const RECOMMENDED_TIER = 'growth' as const

const FEATURES = [
  { key: 'feat1', Icon: CalendarRange },
  { key: 'feat2', Icon: Zap },
  { key: 'feat3', Icon: Banknote },
  { key: 'feat4', Icon: ShieldCheck },
]

const STEPS = [
  { number: '01', key: 'step1', Icon: Building2 },
  { number: '02', key: 'step2', Icon: SlidersHorizontal },
  { number: '03', key: 'step3', Icon: Sparkles },
]
...
function Hero() {
  ...
  return (
    <section className="relative pt-32 pb-20 sm:pt-40 sm:pb-28 overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-cyan-200/30 rounded-full blur-3xl -translate-y-1/2 translate-x-1/4" />
      <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-blue-100/40 rounded-full blur-3xl translate-y-1/2 -translate-x-1/4" />
              ...
              <div className="mt-6 space-y-3">
                {[1, 2, 3, 4].map((row) => (
                  <div key={row} className="grid grid-cols-7 gap-2">
                    <div className="text-[11px] text-gray-500 font-semibold flex items-center">
                      Recurso {row}
                    </div>
                    {[0, 1, 2, 3, 4, 5].map((col) => (
                      <div
...
export default function RealtimeLanding() {
  return (
    <main>
      <LandingNavbar />
      <Hero />
