...
const VERTICAL = 'task' as const
const RECOMMENDED_TIER = 'starter' as const

const FEATURES = [
  { key: 'feat1', Icon: FileText },
  { key: 'feat2', Icon: Milestone },
  { key: 'feat3', Icon: MessageSquare },
  { key: 'feat4', Icon: Signature },
]

const STEPS = [
  { number: '01', key: 'step1', Icon: PenLine },
  { number: '02', key: 'step2', Icon: Send },
  { number: '03', key: 'step3', Icon: Wallet },
]
...
function Hero() {
  ...
  return (
    <section className="relative pt-32 pb-20 sm:pt-40 sm:pb-28 overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-emerald-200/30 rounded-full blur-3xl -translate-y-1/2 translate-x-1/4" />
      <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-teal-100/40 rounded-full blur-3xl translate-y-1/2 -translate-x-1/4" />
