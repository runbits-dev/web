...
const sprints: Sprint[] = [
  ...
  },
  {
    ...
    tasks: [
      { id: '2.1', label: 'Integrar Stripe checkout + webhooks', repo: 'billing-service' },
      { id: '2.2', label: 'Integrar MercadoPago checkout pro', repo: 'billing-service' },
      { id: '2.3', label: 'Página de suscripción en dashboard', repo: 'web' },
      { id: '2.4', label: 'Facturación electrónica (PDF receipt)', repo: 'billing-service' },
    ],
  },
  {
    id: 's3', title: 'Sprint 3 — Features Core', dates: '25–27 abr', color: '#a855f7',
    tasks: [
      { id: '3.1', label: 'Menu CRUD en dashboard (items, categorías, fotos R2)', repo: 'web + restaurant' },
      { id: '3.2', label: 'Push notifications FCM', repo: 'notification-service' },
      { id: '3.3', label: 'Historial de pedidos (usuario + comercio)', repo: 'web + order' },
      { id: '3.4', label: 'Stats reales en dashboard', repo: 'web' },
    ],
  },
  {
...
const services = [
  ...
  { name: 'Restaurant', url: 'restaurant.runbits.dev', up: false },
  { name: 'Order', url: 'order.runbits.dev', up: false },
  { name: 'Notification', url: 'notification.runbits.dev', up: false },
  { name: 'Mobile Web', url: 'runbits.app', up: false },
]
...
const log: { date: string; text: string }[] = [
  ...
  { date: '2026-04-18', text: 'Diagnóstico completo: 4 servicios caídos, gateway path bug, wrangler typos' },
