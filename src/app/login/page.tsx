...
export default function LoginPage() {
  ...
  useEffect(() => {
    ...
    const needs2FAParam = params.get('needs2FA')
    const tempTokenParam = params.get('tempToken')
    if (needs2FAParam === 'true' && tempTokenParam) {
      setNeeds2FA(true)
  ...
  function handleGoogle() {
    ...
    window.location.href = `https://accounts.google.com/o/oauth2/v2/auth?client_id=${GOOGLE_CLIENT_ID}&redirect_uri=${redirectUri}&response_type=code&scope=openid%20email%20profile&prompt=select_account`
  }
      ...
      <div className="w-full max-w-[420px]">
        <div className="bg-white rounded-2xl border border-gray-200 p-8 shadow-sm">
          ...
          <div className="flex gap-3 mb-6">
            <button onClick={handleGoogle} className={socialBtnClass}>
