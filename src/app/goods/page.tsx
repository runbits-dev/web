...
const VERTICAL = 'goods' as const
const RECOMMENDED_TIER = 'starter' as const

const FEATURES = [
  { key: 'feat1', Icon: Package },
  { key: 'feat2', Icon: Truck },
  { key: 'feat3', Icon: Warehouse },
  { key: 'feat4', Icon: Globe },
]

const STEPS = [
  { number: '01', key: 'step1', Icon: ShoppingBag },
  { number: '02', key: 'step2', Icon: Tag },
  { number: '03', key: 'step3', Icon: CreditCard },
]
...
function Hero() {
  ...
  return (
    <section className="relative pt-32 pb-20 sm:pt-40 sm:pb-28 overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-sky-200/30 rounded-full blur-3xl -translate-y-1/2 translate-x-1/4" />
          ...
          <div className="rounded-2xl border border-gray-200 bg-gradient-to-br from-gray-50 to-white shadow-sm overflow-hidden">
            ...
            <div className="p-6 sm:p-10">
              ...
              <div className="mt-6 grid grid-cols-3 sm:grid-cols-6 gap-3">
                {[1, 2, 3, 4, 5, 6].map((i) => (
                  <div key={i} className="aspect-square rounded-xl bg-white border border-gray-100" />
                ))}
              </div>
            </div>
          </div>
...
export default function GoodsLanding() {
  return (
    <main>
      <LandingNavbar />
      <Hero />
